      ...
      <div class="mb-8">
        <div class="relative max-w-2xl">
          <input
            ...
            class="w-full bg-gray-800 text-white placeholder-gray-400 rounded-lg pl-12 pr-4 py-4 text-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:bg-gray-700 transition-colors"
          />
          ...
          <button 
            @click="handleSearch"
            class="absolute right-2 top-2 bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg transition-colors"
          >
            Search
          </button>
        </div>
